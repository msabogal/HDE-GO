...
int input_read_parameters_general(struct file_content * pfc,
  ...
  /** 5) h in [-] and H_0/c in [1/Mpc = h/2997.9 = h*10^5/c] */  /*Revisar para entender como lee*/
  /* Read */
...
int input_read_parameters_species(struct file_content * pfc,
  ...
  class_call(parser_read_double(pfc,"omega_cdm",&param2,&flag2,errmsg),
             ...
             errmsg);
  /* Test */
  class_test(((flag1 == _TRUE_) && (flag2 == _TRUE_)),   /*Revisar lectura de Variables*/
             errmsg,
  ...
  /* ** BUDGET EQUATION ** -> Add your species here */ /* Revisar estan las especies*/
  /* Compute Omega_tot */
  ...
  if (pba->Omega0_fld != 0.) {
    ...
    /** 8.a.2) Equation of state **/   /*Revisar se lee lo necesario para la equacion de estado sin GO*/
    /* Read */
    ...
    if (flag1 == _TRUE_) {
      ...
      else if ((strstr(string1,"GO") != NULL) || (strstr(string1,"go") != NULL)) {
      pba->fluid_equation_of_state = GO;  /*Aqui se colocó GO*/
      }
      else {
    ...
    if (pba->fluid_equation_of_state == GO) { /*Aqui se lee parametros GO*/
      /* Read */
        ...
        class_call(parser_read_double(pfc,"beta_GO",&param1,&flag1,errmsg),
                   errmsg,
                   errmsg);
